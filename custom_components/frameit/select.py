...
class FrameITContentModeSelect(FrameITEntity, SelectEntity):
    """Select entity that switches a frame between pool and pinned.

    Now-playing is not a content mode: the server overlays it on whatever mode
    a frame is in, controlled by the separate Now Playing switch.
    """
